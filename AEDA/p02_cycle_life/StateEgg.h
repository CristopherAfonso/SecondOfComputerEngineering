 ...
 * 
 * @file StateEgg.h 
 * @brief Donde se aloja la declaración de la clase StateEgg y la declaracion
 * de sus metodos. La clase StateEgg es una clase de 5 clases de las cuales
