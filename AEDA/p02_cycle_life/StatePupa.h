 ...
 * 
 * @file StatePupa.h 
 * @brief Donde se aloja la declaración de la clase StatePupa y la declaracion
 * de sus metodos. La clase StatePupa es una clase de 5 clases de las cuales
