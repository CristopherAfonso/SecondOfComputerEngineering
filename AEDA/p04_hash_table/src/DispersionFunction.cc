 ...
 * @date 03/04/2022
 * 
 * @file DispersionFunction.cc
 * @brief Donde se desarrollan las funciones de la clase DispersionFunction contenida
 * en el archivo de cabecera DispersionFunction.h
 *
