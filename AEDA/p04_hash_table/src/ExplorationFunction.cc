 ...
 * @date 03/04/2022
 * 
 * @file ExplorationFunction.cc
 * @brief Donde se desarrollan las funciones de la clase ExplorationFunction contenida
 * en el archivo de cabecera ExplorationFunction.h
 *
